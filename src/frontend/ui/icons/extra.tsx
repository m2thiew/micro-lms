/**
 * src/frontend/ui/icons/extra.tsx
 *
 * Icone extra troate su fonti diverse.
 *
...
export const FbSpinner = forwardRef((props: TIconProps, ref: TIconRef) => {
  return (
    <svg
      width="24"
      height="24"
...
FbSpinner.displayName = "FbSpinner";
